...
RAW_TABLE_DATA_ONE_EXERCISE_PER_LINE = (
    ...
    [
        ...
        ['', '2', 'легкий\\средний бег', '1 км', '4-5/5-7'],
        ['', '3\n60-75%', '1\\4\\'],
        ['', '', 'подтягивания ', '8-10'],
        ['', '', 'приседания со штангой на спине', '8-10', '45-50, 50 было тяжело ']
    ]
)
                ...
                sets=[
                    Set(
                        ...
                        exercises=[
                            ...
                            Exercise(description="приседания со штангой на спине", reps_window="8-10")
                        ],
                        rounds="4"
                    ),
                ],
